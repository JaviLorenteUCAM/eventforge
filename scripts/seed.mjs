...
const ITEMS = [
  ...
  ['PC sobremesa', CAT.av, 6, 'ud', 0.2, 0.45, 0.45, 'Nave B · Rack 1', 'AV-PC-001', { kind: 'av', color: '#60a5fa', requires_power: true, requires_network: true, power_w: 250, signal_out_count: 2 }],
  ['Monitor 27"', CAT.av, 8, 'ud', 0.62, 0.2, 0.48, 'Nave B · Rack 1', 'AV-MON-027', { kind: 'signal_sink', color: '#60a5fa', requires_power: true, power_w: 40, requires_signal: true }],
  ['Pantalla 55"', CAT.av, 3, 'ud', 1.24, 0.08, 0.72, 'Nave B · Suelo', 'AV-PAN-055', { kind: 'signal_sink', color: '#60a5fa', requires_power: true, requires_network: true, power_w: 140, requires_signal: true }],
  ['Proyector', CAT.av, 2, 'ud', 0.38, 0.3, 0.12, 'Nave B · Rack 2', 'AV-PRO-001', { kind: 'signal_sink', color: '#60a5fa', requires_power: true, power_w: 320, requires_signal: true }],
